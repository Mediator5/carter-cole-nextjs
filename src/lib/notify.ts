import { deliver, fromAddress, mailerConfigured, siteUrl } from "./mailer";
    ...
    <div style="padding:22px 24px">
      ...
      <p style="margin:22px 0 0;font-family:Helvetica,Arial,sans-serif;font-size:12px;color:${MUTED}">
        Received ${new Date().toLocaleString("en-US", {
          ...
          dateStyle: "medium",
          timeStyle: "short",
        })} ET &middot; <a href="${siteUrl()}/admin/subscribers" style="color:${MUTED}">Open the dashboard</a>
      </p>
    </div>
  </div>
</body></html>`;
